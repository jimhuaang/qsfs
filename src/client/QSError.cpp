...
QSError StringToQSError(const string &errorCode) {
  static unordered_map<string, QSError, QS::HashUtils::StringHash>
      errorCodeToTypeMap = {
          ...
          {"NoSuchMultipartDownload",     QSError::NO_SUCH_MULTIPART_DOWNLOAD},
          {"NoSuchMultipartUpload",       QSError::NO_SUCH_MULTIPART_UPLOAD},
...
std::string QSErrorToString(QSError err){
  static unordered_map<QSError, string, QS::HashUtils::EnumHash>
      errorTypeToCodeMap = {
          ...
          {QSError::NO_SUCH_MULTIPART_DOWNLOAD    , "NoSuchMultipartDownload"     },
          {QSError::NO_SUCH_MULTIPART_UPLOAD      , "NoSuchMultipartUpload"       },
